...
//
//	// 頂点データサイズ
//	UINT sizeVB = static_cast<UINT>(sizeof(VertexData3D) * modelData_.meshes[0].vertices.size());
//
//	// 頂点バッファ生成
...
//			modelData_.meshes[i].vertices.data(), sizeof(VertexData3D) * modelData_.meshes[i].vertices.size());
//	}
//
//	// 頂点バッファの設定
